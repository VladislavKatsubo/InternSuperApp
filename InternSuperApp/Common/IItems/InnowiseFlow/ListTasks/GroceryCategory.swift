...
enum GroceryCategory: CaseIterable {
    ...
    var iconImage: UIImage {
        switch self {
        case .fruits:
            return UIImage(systemName: "apple.logo") ?? UIImage()
        case .vegetables:
            return UIImage(systemName: "carrot") ?? UIImage()
        case .dairy:
            return UIImage(systemName: "drop.fill") ?? UIImage()
        case .meats:
            return UIImage(systemName: "hare") ?? UIImage()
        case .fish:
            return UIImage(systemName: "fish") ?? UIImage()
        case .grains:
