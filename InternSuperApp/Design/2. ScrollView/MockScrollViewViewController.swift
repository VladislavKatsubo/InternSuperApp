//
//  MockScrollViewViewController.swift
//  InternSuperApp
//
...
final class MockScrollViewViewController: UIViewController {

    typealias Constants = MockScrollViewResources.Constants.UI
    ...
    private let mockButton = MockScrollViewButton()
...
private extension MockScrollViewViewController {
    ...
    func setupMockBlocks() {
        Constants.colors.forEach({
            let mockBlock = MockScrollViewBlockView()
